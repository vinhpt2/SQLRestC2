				...
				NUT.ds.select({ url: InHopDongLaoDong.url +"data/nhansu",where:["manhanvien","=",hd.manhanvien]},function(res){
					if(res.success && res.result.length){
						...
						win_hd.onload=function(){
							...
							this.hd_quoctich.innerHTML=NUT.domains[82].lookup[nv.quoctich][1]||"";
							this.hd_ngaysinh.innerHTML=NUT.dmy(nv.ngaysinh)||"";
							this.hd_gioitinh.innerHTML=NUT.domains[76].lookup[nv.gioitinh][1]||"";
							...
							this.hd_loaihopdong.innerHTML=NUT.domains[83].lookup[hd.loaihopdong][1]||"";
							...
							this.hd_diadiemlv.innerHTML = (nv.diadiemlv || "") + " - " + (NUT.dmlinks[131].lookup[nv.makhuvuc][1]||"");
							this.hd_vitrilv.innerHTML = NUT.dmlinks[147].lookup[hd.vitrilamviec][1]||"";
							...
							if(full){
								...
								this.ck_vitrilv.innerHTML = NUT.dmlinks[147].lookup[nv.vitrilv][1]||"";
								this.ck_vitrilv2.innerHTML = NUT.dmlinks[147].lookup[nv.vitrilv][1]||"";
